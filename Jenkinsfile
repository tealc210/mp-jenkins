        ...
        stage('Scan') {
            ...
            steps {
                withSonarQubeEnv('SonarCloud') {
                    ...
                    cd ./app_code/
                    mvn verify org.sonarsource.scanner.maven:sonar-maven-plugin:sonar -Dsonar.host.url="https://sonarcloud.io" -Dsonar.organization=${SONARCLD_ORG} -Dsonar.projectKey=${SONARCLD_PJ_KEY}
                    '''
