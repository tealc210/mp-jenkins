            ...
            steps {
                sshagent(credentials: ['SSHKEY']) {
                    sh '''
                        ...
                        command4="docker run -d -p 80:8080 -e SPRING_DATASOURCE_URL='jdbc:mysql://${DB_HOST}:3306/db_paymybuddy' --name $IMAGE_NAME $DOCKERHUB_CREDENTIALS_USR/$IMAGE_NAME:$IMAGE_TAG"
